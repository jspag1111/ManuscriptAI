      ...
      <SignedOut>
        <main className="relative overflow-hidden">
          <div className="absolute inset-0 opacity-70" style={{
            backgroundImage:
              'radial-gradient(circle at 15% 20%, rgba(59,130,246,0.22), transparent 26%),' +
              'radial-gradient(circle at 85% 10%, rgba(99,102,241,0.18), transparent 24%),' +
              'radial-gradient(circle at 50% 80%, rgba(14,165,233,0.15), transparent 30%)',
          }} />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6 text-left">
                <p className="inline-flex items-center gap-2 px-3 py-1 text-xs font-semibold rounded-full bg-white/60 border border-white/80 uppercase tracking-wider text-slate-700">
                  AI-assisted manuscript studio
                </p>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-semibold leading-tight text-slate-900">
                  A smarter way to plan and write your next manuscript
                </h1>
                <p className="text-lg text-slate-600 leading-relaxed">
                  Organize sections, iterate drafts with AI, keep references close, and export polished documents—on any device.
                </p>
                ...
                <div className="grid sm:grid-cols-3 gap-4 pt-4">
                  {[{
                    ...
                    desc: 'Thoughtfully scales across desktops, tablets, and phones.',
                  }, {
                    title: 'AI drafting controls',
                    desc: 'Toggle on-demand generation and keep your save tools handy.',
                  }, {
                    title: 'Versioned progress',
                    desc: 'History-aware editing with reference and figure tracking.',
                  }].map((item) => (
              ...
              <div className="bg-white/80 backdrop-blur border border-slate-200 rounded-3xl shadow-2xl shadow-blue-500/10 p-6 lg:p-8 space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-semibold text-slate-700">Workspace preview</p>
                    <p className="text-xs text-slate-500">Cleaner layout, streamlined controls</p>
                  </div>
                ...
                <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-slate-100 p-4 space-y-3 shadow-inner shadow-blue-900/20">
                  <div className="flex items-center justify-between">
                    <div className="h-9 w-9 rounded-lg bg-blue-500/60 border border-white/10 flex items-center justify-center text-white font-semibold">AI</div>
